...
- [Face Landmarks](operators/face_landmarks.md) — Face detection with per-region landmark points — eyes, pupils, brows, nose, lips and the face contour — as channels you can drive geometry or parameters with.
